...
w2=2*f2/Fs;
w=[w1 w2];
[N,wc]=cheb1ord(wp,ws,rp,rs); #order and cutoff frequency
display(N)
display(wc)
Rs=60
[b1,a1]=cheby1(N,Rs,wc,'low'); #Transfer function coefficient
[b2,a2]=cheby1(N,Rs,wc,'high');
[b3,a3]=cheby1(N,Rs,wc);
[b4,a4]=cheby1(N,Rs,wc,'stop');
freqz(b1,a1);
figure;
freqz(b2,a2);
figure;
